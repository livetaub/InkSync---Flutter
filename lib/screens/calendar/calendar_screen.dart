...
class _CalendarScreenState extends State<CalendarScreen> {
        ...
        children: [
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final dayEvents = _monthEvents.where((e) => DateUtils.isSameDay(e.eventDate, date)).toList();
              final hasEvents = dayEvents.isNotEmpty;
              final hasOpenEvents = dayEvents.any((e) => !e.isDone);

              return DragTarget<CalendarEvent>(
                onWillAcceptWithDetails: (details) => true,
                onAcceptWithDetails: (details) {
                  final event = details.data;
                  if (!DateUtils.isSameDay(event.eventDate, date)) {
                    _moveEvent(event, date);
                  }
                },
                        ...
                        children: [
                          ...
                          if (hasEvents)
                            Container(
                              ...
                              height: 4,
                              decoration: BoxDecoration(
                                color: hasOpenEvents ? Colors.redAccent : Colors.green,
                                shape: BoxShape.circle,
                              ),
                            ),
                        ],
  ...
  Widget _buildEventCard(CalendarEvent event, bool isDark, Color cardColor, Color textColor) {
    ...
    final cardContainer = GestureDetector(
              ...
              Column(
                ...
                children: [
                  ...
                  PopupMenuButton<String>(
                    ...
                    itemBuilder: (context) => [
                      const PopupMenuItem(value: 'tomorrow', child: Text('Move to next day')),
